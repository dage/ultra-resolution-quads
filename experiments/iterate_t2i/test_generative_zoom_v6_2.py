...
DATASET_ID = "generative_infinity_zoom_v6_2"
...
def generate_html_report(report_text, score, img_stitched, img_crop):
    html = f"""
    <html>
    <head><title>Generative Zoom V6-2 Analysis</title></head>
    <body style="font-family: sans-serif; max-width: 800px; margin: 0 auto; padding: 20px;">
        <h1>Generative Zoom V6-2 Analysis</h1>
        <p><strong>Experiment:</strong> Soft Inpainting via Differential Diffusion (Denoise 1.0).</p>
    ...
    """
    with open("artifacts/gen_zoom_v6_2_debug/report.html", "w") as f:
        f.write(html)
    print("\n[Report] Generated report.html in artifacts/gen_zoom_v6_2_debug/")
...
def run_test(args):
    try:
        ...
        debug_dir = Path("artifacts/gen_zoom_v6_2_debug")
